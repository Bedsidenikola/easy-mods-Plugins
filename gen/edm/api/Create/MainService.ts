...
import { MainRepository, MainEntityOptions } from "../../dao/Create/MainRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";

const validationModules = await Extensions.loadExtensionModules("test-Create-Main", ["validate"]);

@Controller
class MainService {

    private readonly repository = new MainRepository();

    @Get("/")
    public getAll(_: any, ctx: any) {
        try {
            const options: MainEntityOptions = {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/test/gen/edm/api/Create/MainService.ts/" + entity.Id);
    ...
    public getById(_: any, ctx: any) {
        try {
            ...
            if (entity) {
                ...
                HttpUtils.sendResponseNotFound("Main not found");
            }
        } catch (error: any) {
            this.handleError(error);
        }
